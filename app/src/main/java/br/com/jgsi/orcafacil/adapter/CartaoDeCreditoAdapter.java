 ...
 */
public class CartaoDeCreditoAdapter extends BaseAdapter {

    private List<CartaoDeCredito> cartoes;
    private Activity activity;

    public CartaoDeCreditoAdapter(List<CartaoDeCredito> cartoes, Activity activity) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        View item = activity.getLayoutInflater().inflate(R.layout.cartao_item, null);
